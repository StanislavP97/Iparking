      ...
      >
        ...
        <div className="w-full md:w-1/2 relative">
          <img
            src={ImageMockup}
            alt="App Mockup"
            className="mx-auto h-auto max-w-full object-contain absolute top-[-320px] max-sm:left-[60px] max-sm:max-h-[320px] max-h-[600px]"
          />
        </div>
        ...
        <div className="w-full text-center md:w-1/2 md:text-left">
          ...
          <div className="flex flex-wrap gap-4 justify-center md:justify-start">
            ...
            <motion.a
              href="#"
              className="flex h-14 items-center gap-3 rounded-xl bg-black px-6 text-white"
              whileHover={{ scale: 1.03, opacity: 0.98 }}
              whileTap={{ scale: 0.98 }}
              transition={spring}
            >
