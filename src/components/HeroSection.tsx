    ...
    <section className="relative min-h-screen overflow-hidden bg-background">
      ...
      <div className="absolute left-1/2 top-20 z-20 -translate-x-1/2 md:left-[40%]">
        <div className="rounded-[2rem] border-2 border-dashed border-foreground/40 px-8 py-5 text-center">
          ...
          <p className="text-lg font-bold text-foreground">
            <span className="text-primary">2</span> первые парковки
          </p>
      ...
      <nav className="relative z-20 flex items-center justify-end gap-6 px-8 py-6 md:px-16">
        ...
        <div className="flex items-center gap-1 text-sm text-foreground/60">
          <a href="#" className="text-foreground transition-colors hover:text-primary">En</a>
          <span>/</span>
          <a href="#" className="font-semibold text-foreground">Ru</a>
          <span>/</span>
          <a href="#" className="text-foreground transition-colors hover:text-primary">De</a>
        </div>
      </nav>
      ...
      <div className="relative z-10 flex min-h-[calc(100vh-80px)] flex-col justify-center px-8 md:px-16 lg:px-24">
        ...
        {/* Headline */}
        <h1 className="mb-2 text-3xl font-bold leading-tight md:text-5xl lg:text-[3.2rem]" style={{ lineHeight: 1.15 }}>
          Паркшеринг!
          <br />
          Помогая с парковкой,
          <br />
        ...
        <div className="mt-10 flex flex-wrap items-center gap-4">
          <span className="text-sm text-foreground/70">Скачать приложение:</span>
          <a
          ...
          >
            ...
            <div className="text-left">
              <div className="text-[10px] uppercase leading-none text-foreground/60">Доступно в</div>
